...
@section('title','AFO SHOP || PRODUCT PAGE')
							...
							<div class="shop-sidebar">
								...
								<div class="single-widget range">
									...
									{{-- <ul class="check-box-list">
										<li>
											<label class="checkbox-inline" for="1"><input name="news" id="1" type="checkbox">RP.20.000 - RP.50.000<span class="count">(3)</span></label>
										</li>
										<li>
											<label class="checkbox-inline" for="2"><input name="news" id="2" type="checkbox">RP.50.000 - RP.100.000<span class="count">(5)</span></label>
										</li>
										<li>
											<label class="checkbox-inline" for="3"><input name="news" id="3" type="checkbox">RP.100.000 - RP.250.000<span class="count">(8)</span></label>
										</li>
									</ul> --}}
								</div>
								<!--/ End Shop By Price -->
